...
<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="~/Pages/Login/Default.aspx.cs" Inherits="ClearCanvas.ImageServer.Web.Application.Pages.Login.LoginPage" %>
    ...
    <asp:Panel ID="LoginSplash" DefaultButton="LoginButton" runat="server">
        ...
        <div id="LoginCredentials">
            <table>
                <tr>
                    <td align="right">
                        <asp:Label ID="Label2" runat="server" Text="<%$Resources: Labels,UserID %>"></asp:Label>
                    </td>
                    <td align="right">
                        <asp:TextBox runat="server" ID="UserName" CssClass="LoginTextInput"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td align="right">
                        <asp:Label ID="Label3" runat="server" Text="<%$Resources: Labels,Password %>"></asp:Label>
                    </td>
                    <td align="right">
                        <asp:TextBox runat="server" ID="Password" TextMode="Password" CssClass="LoginTextInput"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" align="right">
                        <asp:Button runat="server" ID="LoginButton" OnClick="LoginClicked" Text="<%$Resources: Labels,ButtonLogin %>"
                            CssClass="LoginButton" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2" align="right">
                        <asp:LinkButton ID="LinkButton1" runat="server" CssClass="LoginLink" OnClick="ChangePassword">
                            <asp:Label ID="Label4" runat="server" Text="<%$Resources: Labels,ChangePassword%>"></asp:Label></asp:LinkButton>
                    </td>
                </tr>
            </table>
        </div>
